...
public class ProbabilityTableDataTests
{
    ...
    public void FromActor_WhenCalled_ReturnsProbabilityTableData()
    {
        ...
        // Assert
        CollectionAssert.AreEquivalent(new List<string> { "Durak","10", "12", "14" }, tableData.HeaderRow.ToList());
        CollectionAssert.AreEquivalent(new List<string> { "Str", "0.55", "0.45", "0.35" }, tableData.StrengthRow.ToList());
        CollectionAssert.AreEquivalent(new List<string> { "Dex", "1.05", "0.95", "0.85" }, tableData.DexterityRow.ToList());
        ...
        CollectionAssert.AreEquivalent(new List<string> { "Cha", "0.5", "0.4", "0.3" }, tableData.CharismaRow.ToList());
    }
