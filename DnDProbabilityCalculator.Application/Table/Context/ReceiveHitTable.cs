...
public class ReceiveHitTable
{
    ...
    {
        var attackModifierRow = new List<string> { $"{inputVariables.NumberOfAttacks} Attacks/Mod" }
            .Concat(inputVariables.AttackModifiers
                .Select(modifier => modifier.ToString())).ToList();
