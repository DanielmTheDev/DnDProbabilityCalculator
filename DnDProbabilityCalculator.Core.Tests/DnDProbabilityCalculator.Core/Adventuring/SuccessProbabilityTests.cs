...
public class SuccessProbabilityTests
{
    ...
    public void CalculateProbability_WhenCalled_ReturnsProbabilities(int positiveModifier, int negativeModifier, AdvantageType advantageType, double expectedProbability)
    {
        // Act
        var actualProbability = Probability.Calculate(positiveModifier, negativeModifier, advantageType);
